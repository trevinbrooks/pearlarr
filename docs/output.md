...
<!-- gen:json-events - GENERATED by scripts/gen_docs.py from pearlarr/modules/output/events.py + textline.py; do not edit between the markers; regenerate: uv run python scripts/gen_docs.py -->
